...
public class Juegos03 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Crea los sonidos
        sonidoCorrecto = MediaPlayer.create(this, R.raw.two);
    ...
    private void cargarPregunta() {
        ...
        opciones.add(R.drawable.unoo); // Respuesta correcta
        opciones.add(R.drawable.dos);
        opciones.add(R.drawable.tres);
        opciones.add(R.drawable.cuatrooo);

        preguntaActual = new Pregunta(getString(R.string.boton02), R.drawable.dos, opciones);
        // ----------------------------------------
